...
class UserController extends Controller {
  ...
  async login() {
    ...
    ctx.helper.success(ctx, 1, '成功', {"token":"admin-token"})
  }

  async getinfo() {
    const { ctx, app } = this;
    const res = {"code":1,"data":{"roles":["editor"],"introduction":"I am a super administrator","avatar":"https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif","name":"Super Admin"}}
    //console.log(333333333, tree_data);
    this.ctx.helper.success(ctx, 1, '成功', res);
  }
  ...
  async loginindex() {
    ...
    ctx.helper.success(ctx, 1, '成功', {"token":phone})
  }
